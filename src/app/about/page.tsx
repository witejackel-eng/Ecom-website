  ...
  return (
    <main className="min-h-screen pt-32 pb-20 bg-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up">
          <h1 className="font-heading text-5xl mb-8 text-gray-900">About DeviceDestination</h1>
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <h2 className="font-heading text-3xl text-gray-900 mt-12 mb-6">Our Mission</h2>
            ...
            <h2 className="font-heading text-3xl text-gray-900 mt-12 mb-6">Why Choose DeviceDestination</h2>
