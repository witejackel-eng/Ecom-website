...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col font-sans bg-background text-foreground overflow-x-hidden selection:bg-teal-500/30 noise-bg" suppressHydrationWarning>
        <CartProvider>
          <Navbar />
          <CartDrawer />
