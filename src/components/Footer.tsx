...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-32 pb-16 overflow-hidden border-t border-[rgba(255,138,0,0.2)] bg-[var(--color-navy)]">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-[var(--color-tangerine)]/30 to-transparent" />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="lg:col-span-5 space-y-12">
            <FadeIn direction="none">
              <Link href="/" className="text-4xl font-black text-white tracking-tighter">
                DeviceDestination<span className="text-[var(--color-tangerine)]">.</span>
              </Link>
              <p className="mt-8 text-xl text-gray-300 leading-relaxed max-w-md font-medium">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 text-gray-400 group">
                <MapPin className="h-5 w-5 text-[var(--color-tangerine)] shrink-0" />
                <span className="text-sm leading-relaxed">
                  Plot No. 94, 3rd Floor, Block - B, Sector - 13, Dwarka, New Delhi - 110075
                </span>
              </div>
              <div className="flex items-center gap-4 text-gray-400">
                <Phone className="h-5 w-5 text-[var(--color-tangerine)] shrink-0" />
                <div className="flex flex-col text-sm">
                  <a href="tel:+918368561919" className="hover:text-[var(--color-tangerine)] transition-colors">+91 83685 61919</a>
                </div>
              </div>
              <div className="flex items-center gap-4 text-gray-400">
                <Mail className="h-5 w-5 text-[var(--color-tangerine)] shrink-0" />
                <a href="mailto:manish@insight-solutions.in" className="text-sm hover:text-[var(--color-tangerine)] transition-colors">manish@insight-solutions.in</a>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 gap-12">
              {footerSections.map((section) => (
                <StaggerItem key={section.title} className="p-6 rounded-2xl border border-[rgba(255,138,0,0.1)] hover:border-[rgba(255,138,0,0.4)] transition-all">
                  ...
                  <ul className="space-y-6">
                    {section.links.map((link) => (
                      <li key={link.name}>
                        <Link 
                          href={link.href} 
                          className="text-gray-400 hover:text-[var(--color-tangerine)] text-sm transition-all duration-300 flex items-center gap-2 group"
                        >
                          {link.name}
        ...
        {/* Massive Watermark */}
        <div className="relative pt-16 border-t border-[rgba(255,138,0,0.2)] overflow-hidden">
          ...
          <div className="absolute bottom-16 left-0 w-full flex flex-col md:flex-row justify-between items-center gap-8 px-2">
            ...
            <div className="flex gap-8">
              <a href="https://facebook.com" className="text-gray-500 hover:text-[var(--color-tangerine)] transition-colors flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
                <Globe size={16} /> Facebook
              </a>
              <a href="https://linkedin.com" className="text-gray-500 hover:text-[var(--color-tangerine)] transition-colors flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
