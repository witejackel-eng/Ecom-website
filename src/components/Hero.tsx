...
export default function Hero() {
  return (
    <section className="relative min-h-[70vh] flex items-center bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <FadeIn direction="up">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl leading-[1.1] text-[#1A1A1A] mb-8">
              Premium Security & <br/> <span className="text-[#F28C38]">Surveillance Solutions</span>
            </h1>
            <p className="text-lg text-[#666666] mb-10 max-w-2xl leading-relaxed">
              Enterprise-grade CCTV and surveillance systems designed for homes, businesses and institutions.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                href="/products"
                className="inline-flex items-center gap-2 rounded-lg bg-[#F28C38] px-8 py-4 text-sm font-bold text-white hover:bg-[#C96E1A] transition-all duration-300 group shadow-md shadow-[#F28C38]/20"
              >
                Explore Products
